...
import { BarChart3, Bell, BriefcaseBusiness, CheckCircle2, ChevronDown, Eye, EyeOff, FileCheck2, LayoutDashboard, LockKeyhole, LogOut, Mail, Menu, PanelLeft, Search, Settings2, ShieldCheck, UsersRound, UserRoundPlus } from "lucide-react";
...
export default function DashboardLayout({
  ...
  const signInView = (
    <main className="relative flex h-dvh max-h-dvh min-h-0 overflow-hidden bg-[#eef0ff] font-sans text-[#14204b]">
      <section className="relative hidden min-h-0 flex-1 flex-col justify-between overflow-hidden bg-[#06133e] px-10 py-10 text-white lg:flex xl:px-14 xl:py-12">
        ...
        <div className="absolute -bottom-24 -left-16 h-72 w-[42rem] rotate-[-8deg] rounded-[50%] border border-indigo-400/20" aria-hidden="true" />

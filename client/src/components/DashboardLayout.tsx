    ...
    <main className="login-shell relative flex h-dvh max-h-dvh min-h-0 overflow-hidden bg-[#eef0ff] font-sans text-[#14204b]">
      ...
      <section className="login-panel relative flex h-full min-h-0 w-full items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_75%_20%,rgba(197,205,255,0.85),transparent_36%),linear-gradient(135deg,#f7f7ff,#eceeff)] px-4 py-4 sm:px-8 lg:max-w-[660px] lg:px-12 xl:max-w-[720px] xl:px-16"><div className="w-full max-w-[560px]"><div className="mb-3 flex items-center gap-3 lg:hidden"><div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white p-1 shadow-sm"><img src={companyBranding.companyLogoUrl} alt={companyBranding.companyName} className="block h-full w-full object-contain" /></div><p className="text-lg font-semibold tracking-tight">Expertaid <span className="text-[#4d66df]">CRM</span></p></div>
        <div className="login-card max-h-full overflow-hidden rounded-[1.8rem] bg-white px-6 py-6 shadow-[0_24px_70px_rgba(50,66,150,0.2)] sm:px-10 sm:py-7"><div className="mb-4 flex justify-center"><img src={companyBranding.companyLogoUrl} alt={companyBranding.companyName} className="block h-16 w-[250px] object-contain sm:h-20 sm:w-[300px]" /></div><div className="text-center"><p className="text-xs font-bold uppercase tracking-[0.25em] text-[#6b5ce7]">Welcome back</p><h2 className="mt-2 text-3xl font-semibold tracking-[-0.04em] text-[#10204f] sm:text-4xl">Sign in to your account</h2><p className="mx-auto mt-2 max-w-md text-sm leading-5 text-slate-500">Access your workspace to manage clients, services and operations seamlessly.</p></div>
          ...
          <div className="mt-5 flex items-center gap-3 text-xs text-slate-400"><span className="h-px flex-1 bg-slate-200" /><span>OR</span><span className="h-px flex-1 bg-slate-200" /></div><button type="button" onClick={startLogin} className="mx-auto mt-4 flex h-10 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-[#5968e8] hover:text-[#4d54c7]" aria-label="Continue with Google"><svg aria-hidden="true" viewBox="0 0 24 24" className="h-4 w-4"><path fill="#4285F4" d="M21.35 12.27c0-.72-.06-1.42-.18-2.09H12v3.96h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.14c1.84-1.69 2.91-4.18 2.91-7.26Z"/><path fill="#34A853" d="M12 21.7c2.63 0 4.84-.87 6.45-2.36l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.69-1.72-5.46-4.03H3.3v2.53A9.74 9.74 0 0 0 12 21.7Z"/><path fill="#FBBC05" d="M6.54 13.78A5.85 5.85 0 0 1 6.23 12c0-.62.11-1.22.31-1.78V7.69H3.3A9.75 9.75 0 0 0 2.25 12c0 1.57.38 3.05 1.05 4.31l3.24-2.53Z"/><path fill="#EA4335" d="M12 6.19c1.43 0 2.71.49 3.72 1.46l2.79-2.79C16.84 3.22 14.63 2.3 12 2.3a9.74 9.74 0 0 0-8.7 5.39l3.24 2.53C6.54 7.91 8.69 6.19 12 6.19Z"/></svg><span>Continue with Google</span></button><div className="mt-4 flex items-center justify-center gap-2 text-sm text-slate-400"><ShieldCheck className="h-5 w-5 text-slate-500" />Secure access to your Expertaid CRM workspace</div>

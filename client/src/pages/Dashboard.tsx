...
export default function Dashboard() {
  ...
  const computed = useMemo(() => {
    ...
    const validInvoices = invoiceRows.filter(row => row.status !== "Cancelled" && belongsToCurrentSession(row));
    ...
    return { invoiceValue, receiptValue, totalClientValue, todayCollected, monthlyCollected, yearCollected: sessionCollected, monthlyCollections, clientGrowth, dueClientPayments, aging, pendingClientPayments: dueClientPayments.length, dueTotal: clientDueTotal };

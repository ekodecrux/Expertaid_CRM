...
export function buildClientExportRecord(
  ...
  return {
    ...
    "Institute Type": extras.projectType === "ERP" ? client.instituteType : "Not applicable",
    ...
    "Pricing Mode": client.pricingMode === "perStudent" ? "Per Student" : "Package",
    "Per Student / Employee Price": client.pricingMode === "perStudent" ? Number(client.perStudentPrice ?? 0) : "",
    "Package Price": client.pricingMode === "package" ? Number(client.packagePrice ?? 0) : "",
    "Base Amount": client.pricingMode === "package" ? Number(client.packagePrice ?? client.price ?? 0) : Number(client.noOfStudents ?? 0) * Number(client.perStudentPrice ?? 0),

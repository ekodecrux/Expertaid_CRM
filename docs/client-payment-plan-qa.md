...
The final desktop preview now shows the payment-cycle select value as “Installments” and the schedule heading as “Billing schedule (Installments)”; the rest of the payment position and planner layout remains intact.

...
- [x] Add regression coverage for Invoice Summary GST reconciliation
...
- [x] Pass Client-list return context when opening a receipt from Payment history
- [x] Restore the Client list and payment-history modal after closing that receipt
- [x] Preserve normal Receipts-module close behavior when no Client context is present
...
- [x] Fix ERP Primary receipt hydration so the ₹7 reminder amount is not reduced to ₹6.80 and charged GST again
- [x] Keep receipt product value, GST, grand total, and submitted amount consistent for inclusive reminder payments
- [x] Add regression coverage for ERP Primary receipt GST handling
...
- [x] Remove Client Portfolio Value, Monthly Collections, and Open Due summary cards from Reports
- [x] Preserve report tabs, Session/Search/actions, and data tables
- [x] Test, visually verify, and publish the simplified Reports layout

...
export const paymentPlans = mysqlTable("paymentPlans", {
  ...
  projectId: int("projectId"),
  paymentCycle: mysqlEnum("paymentCycle", ["single", "terms", "installments", "months"]).default("installments").notNull(),
...
export const clientProducts = mysqlTable("clientProducts", {
  ...
  gstRate: decimal("gstRate", { precision: 5, scale: 2 }).default("0.00").notNull(),
  gstMode: mysqlEnum("gstMode", ["inclusive", "exclusive"]).default("exclusive").notNull(),
  subtotal: decimal("subtotal", { precision: 14, scale: 2 }).notNull(),
  gstAmount: decimal("gstAmount", { precision: 14, scale: 2 }).notNull(),
  totalAmount: decimal("totalAmount", { precision: 14, scale: 2 }).notNull(),
  paidAmount: decimal("paidAmount", { precision: 14, scale: 2 }).default("0.00").notNull(),
  paymentStatus: mysqlEnum("paymentStatus", ["Pending", "Partially Paid", "Paid"]).default("Pending").notNull(),
  dueDate: varchar("dueDate", { length: 32 }),
  paymentDate: varchar("paymentDate", { length: 32 }),
  paymentMode: varchar("paymentMode", { length: 64 }),
  transactionReference: varchar("transactionReference", { length: 128 }),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
});
